  ...
  server.tool(
    ...
    async (params) => {
      ...
      const contextMarkdown = [
        ...
        `- 학생용 문제지에는 문항, 배점만 제시하고 정답·해설·채점 기준은 넣지 마세요.`,
        `- 선택형에는 별도 정답 기입란을 만들지 마세요. 학생은 선택지 번호 자체에 표시하거나 시험지에 직접 표시합니다.`,
        `- 서술형·논술형 문항에만 필요한 만큼 빈 작성 공간을 제공합니다. 밑줄 기호로 공란을 표시하지 말고 빈 칸/여백으로 둡니다.`,
        `- 학생용 문제지 끝에는 \`- 끝 -\`을 넣어 시험지처럼 마무리하세요.`,
        ...
        `- {{총점}}: 문항별 배점 합계`,
        `**학생용 문제지**`,
        `- {{문항 발문1}}, {{보기1}}, {{선택지1-1}}, {{선택지1-2}}, {{선택지1-3}}, {{선택지1-4}}, {{선택지1-5}}, {{배점1}}, {{답란1}}`,
        `- 선택형 선택지 칸에는 번호를 포함한 전체 줄을 넣으세요. 예: {{선택지1-1}} = \`① 상대의 말을 끝까지 듣는다.\``,
        `- 서술형처럼 선택지가 없는 문항은 선택지 칸을 모두 빈칸으로 두세요. 그러면 번호 줄도 출력되지 않습니다.`,
        `- {{문항 발문2}}, {{보기2}}, {{선택지2-1}}, {{선택지2-2}}, {{선택지2-3}}, {{선택지2-4}}, {{선택지2-5}}, {{배점2}}, {{답란2}}`,
        `- {{문항 발문3}}, {{보기3}}, {{선택지3-1}}, {{선택지3-2}}, {{선택지3-3}}, {{선택지3-4}}, {{선택지3-5}}, {{배점3}}, {{답란3}}`,
        `- {{문항 발문4}}, {{보기4}}, {{선택지4-1}}, {{선택지4-2}}, {{선택지4-3}}, {{선택지4-4}}, {{선택지4-5}}, {{배점4}}, {{답란4}}`,
        `- {{문항 발문5}}, {{보기5}}, {{선택지5-1}}, {{선택지5-2}}, {{선택지5-3}}, {{선택지5-4}}, {{선택지5-5}}, {{배점5}}, {{답란5}}`,
        `- 선택지가 없는 서술형 문항은 선택지 칸을 빈칸으로 두고, 보기형 문항은 {{보기N}}에 <보기> 내용을 별도로 넣어 학생용 문제지에 보이게 하세요.`,
        `- 선택형 선택지는 한 줄에 하나씩 제시됩니다. 절대 발문 한 칸에 ①~⑤를 모두 붙여 쓰지 마세요.`,
        `**교사용 정답 및 해설지**`,
        ...
        `- {{수행평가 제목}}, {{평가 기간}}, {{수행평가 유형}}, {{제출 형식}}, {{제출 분량}}`,
        `- {{수행 과제 안내}}, {{성취기준 코드}}, {{성취기준 및 평가 목표}}`,
        `- {{제출물 및 유의사항}}, {{개인정보 유의사항}}, {{허위 작성 처리}}, {{필수 포함 조건}}`,
        `- {{수행 절차1}}, {{확인 사항1}}, {{수행 절차2}}, {{확인 사항2}}, {{수행 절차3}}, {{확인 사항3}}, {{수행 절차4}}, {{확인 사항4}}`,
        `- {{평가 영역1}}, {{배점1}}, {{우수1}}, {{보통1}}, {{미흡1}}`,
        `- {{평가 영역2}}, {{배점2}}, {{우수2}}, {{보통2}}, {{미흡2}}`,
        `- {{평가 영역3}}, {{배점3}}, {{우수3}}, {{보통3}}, {{미흡3}}`,
        `- {{활동지 제목}}, {{활동 안내}}, {{활동 자료}}, {{활동 문항1}}, {{활동 답란1}}, {{활동 문항2}}, {{활동 답란2}}, {{활동 문항3}}, {{활동 답란3}}`,
        `- {{성찰 질문1}}, {{성찰 질문2}}, {{성찰 질문3}}, {{성찰 질문4}}`,
        ``,
        '',
