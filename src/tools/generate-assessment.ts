  ...
  server.tool(
    ...
    async (params) => {
      ...
      const contextMarkdown = [
        ...
        `**상단 메타**: {{교과/과목}}, {{학년/반}}, {{단원/주제}}, {{평가 유형}}, {{평가일}}, {{평가 목표}}, {{총점}}`,
        `**문항 (1~5)**: {{문항 번호1}}~{{문항 번호5}}, {{문항 내용1}}~{{문항 내용5}}, {{배점1}}~{{배점5}}`,
        `**루브릭 (3영역)**: {{평가 영역1}}~{{평가 영역3}}, {{우수1}}~{{우수3}}, {{보통1}}~{{보통3}}, {{미흡1}}~{{미흡3}}`,
        ``,
        `⚠ 템플릿은 5문항 구조입니다. 20문항 생성 시에는 section_xml을 직접 확장하거나 5문항씩 분할하세요.`,
        ``,
        '',
