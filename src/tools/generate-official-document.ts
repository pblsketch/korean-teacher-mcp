  ...
  server.tool(
    ...
    async (params) => {
      ...
      const guideMarkdown = [
        ...
        `- 공문 목적을 먼저 판별합니다: 자료 제출, 회신, 협조 요청, 홍보 협조, 품의/구매, 긴급 알림.`,
        `- 자료 제출은 \`붙임과 같이 제출합니다\`, 회신은 \`검토 결과를 회신합니다\`, 협조 요청은 \`협조하여 주시기 바랍니다\`를 기본 문장으로 삼습니다.`,
        `- 품의/구매 공문은 견적·시안 확인, 예산과목, 품의가능액, 발주, 납품/청구/완료 확인 흐름이 드러나게 정리합니다.`,
