  ...
  server.tool(
    ...
    async (params) => {
      ...
      const contextMarkdown = [
        ...
        `- **template**: \`"discussion"\``,
        `- **필수 구성**: 논제, 배경 자료, 핵심 용어, 토론 규칙, 역할 분담, 입장 정리표, 근거 찾기표, 발언 기록표, 토론 후 성찰, 자기/동료 평가, 실제 학생 활동지, 차시별 상세 활동지`,
        ...
        `- 실제 수업용 산출물은 1차시 논제 이해, 2차시 근거 조사, 3차시 토론 실행, 4차시 합의문·성찰 활동지를 각각 작성 공간까지 포함해 구성합니다.`,
        ``,
        `## 교사 발문 참고`,
