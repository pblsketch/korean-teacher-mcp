...
- 하단: 토론 기록지 표 (발언자/발언내용/근거 열)

### 업무 계획서 (proposal)
- 채울 자리 표시 16개: {{대분류 제목 1~3}}, {{소분류 제목 1~3}}, {{항목명}}, {{항목 내용}}, {{세부 내용}}, {{내용}}, {{열 제목 1~4}}, {{데이터}}, {{기대 효과 내용}}
- 대분류/소분류 계층 구조, 표 포함

### 회의록 (minutes)
- 채울 자리 표시 9개: {{회의록 제목}}, {{YYYY년 MM월 DD일 HH:MM}}, {{장소}}, {{참석자 목록}}, {{안건 내용}}, {{논의 내용}}, {{결정 사항}}, {{향후 조치 사항}}, {{작성자}}
- 상단 메타 표 + 안건별 내용 구조

### 업무 체크리스트 (checklist)
- 채울 자리 표시 11개: {{제목}}, {{학년도}}, {{학급}}, {{기간}}, {{담당교사}}, {{점검목적}}, {{작성일}}, {{기호안내}}, {{체크리스트표}}, {{비고}}, {{담당교사 서명란}}
- 체크리스트표는 markdown 표 → OWPML 자동 변환

### 학급 명렬표 (roster)
- 채울 자리 표시 11개: {{학년도}}, {{학교명}}, {{학년}}, {{학급}}, {{명렬표 제목}}, {{인원}}, {{담당교사}}, {{작성일}}, {{명렬표 본문}}, {{비고 내용}}, {{담당교사 성명}}
- 명렬표 본문은 markdown 표 → OWPML 자동 변환

### 공문서 (gonmun)
- 내부결재: 채울 자리 표시 10개 (기관명, 수신자, 경유, 제목, 본문1, 본문2, 표 또는 상세내용, 직위 성명, 시행번호, 시행일자)
- 외부공문: +6개 (우편번호, 주소, 전화번호, 팩스번호, 이메일, 홈페이지)

### 가정통신문 (parent-newsletter)
- 채울 자리 표시 12개: {{학교명}}, {{제목}}, {{인사말}}, {{본문내용}}, {{세부안내}}, {{상세내용}}, {{문의안내}}, {{날짜}}, {{학교장명}}, {{학교정보}}, {{회신제목}}, {{회신내용}}
- 회신 불필요 시 {{회신제목}}/{{회신내용}} 빈 문자열

### 보고서 (report)
- 채울 자리 표시 18개: {{보고서 제목}}, {{문서 유형 또는 부제}}, {{문서번호}}, {{소속 학교/기관명}}, {{부서/학년/학과}}, {{작성자 성명}}, {{YYYY년 MM월 DD일}}, {{섹션 제목}}, {{본문 내용}}, {{소제목}}, {{소제목 내용}}, {{항목1~4}}, {{결론 및 건의사항}}, {{결론 내용}}, {{데이터}}
